import { CRMTestAccommodation, CRMTestAccommodations } from '../../../../../src/v3/crm/common/test-accommodation';
...
describe('CRMTestAccommodation', () => {
  describe('mapFromSARAS', () => {
    test('GIVEN a saras accommodation WHEN called THEN the crm accommodation type is returned', () => {
      ...
      expect(CRMTestAccommodation.mapFromSARAS(undefined)).toEqual(undefined);
  ...
  describe('mapFromSARASArray', () => {
    test('GIVEN undefined WHEN called THEN undefined is returned', () => {
      expect(CRMTestAccommodation.mapFromSARASArray(undefined)).toEqual(undefined);
    });
