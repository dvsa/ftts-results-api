...
npx ts-json-schema-generator --path 'src/shared/interfaces/result.ts' --type 'SARASResultBody' --validation-keywords notEmpty --out src/v3/schemas/SARASResultBodyV3.schema.json
